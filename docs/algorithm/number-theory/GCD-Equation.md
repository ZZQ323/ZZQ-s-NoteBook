...
**很多定理只要求“互素”，而有些定理要求“必须是素数”，这一点得非常注意。**{.color-lightblue}
...
借用代数基本定理去理解：**多个数互素只是代表着他们作为整体并没有公用的因子，而两两互素代表每两个之间就已经没有公用的因子了**{.color-lightblue}。
...
简单来说，假设$a<b<c$，根据代数基本定理的观点，我们会发现：
